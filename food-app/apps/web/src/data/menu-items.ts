...
export const menuItems: MenuItem[] = [
  // ── Mama Cee's Buka ─────────────────────────────────────────────────
  {
    id: 'm1', restaurantId: 'r1', category: 'Soups',
    name: 'Egusi Soup',
  ...
  {
    id: 'm2', restaurantId: 'r1', category: 'Soups',
    name: 'Efo Riro',
  ...
  {
    id: 'm3', restaurantId: 'r1', category: 'Soups',
    name: 'Gbegiri & Ewedu',
  ...
  {
    id: 'm4', restaurantId: 'r1', category: 'Swallow',
    name: 'Pounded Yam',
  ...
  {
    id: 'm5', restaurantId: 'r1', category: 'Swallow',
    name: 'Amala',
  ...
  {
    id: 'm6', restaurantId: 'r1', category: 'Rice Dishes',
  ...
  {
    id: 'm7', restaurantId: 'r1', category: 'Drinks',
  ...
  // ── Suya Spot ────────────────────────────────────────────────────────
  {
    id: 'm8', restaurantId: 'r2', category: 'Suya & Grills',
    name: 'Beef Suya',
  ...
  {
    id: 'm9', restaurantId: 'r2', category: 'Suya & Grills',
    name: 'Chicken Suya',
  ...
  {
    id: 'm10', restaurantId: 'r2', category: 'Suya & Grills',
    name: 'Ram Suya (Asun)',
  ...
  {
    id: 'm11', restaurantId: 'r2', category: 'Kilishi',
  ...
  {
    id: 'm12', restaurantId: 'r2', category: 'Sides',
  ...
  {
    id: 'm13', restaurantId: 'r2', category: 'Drinks',
    name: 'Kunu Zaki',
  ...
  // ── Jollof Kitchen ──────────────────────────────────────────────────
  {
    id: 'm14', restaurantId: 'r3', category: 'Rice Dishes',
  ...
  {
    id: 'm15', restaurantId: 'r3', category: 'Rice Dishes',
  ...
  {
    id: 'm16', restaurantId: 'r3', category: 'Rice Dishes',
  ...
  {
    id: 'm17', restaurantId: 'r3', category: 'Proteins',
  ...
  {
    id: 'm18', restaurantId: 'r3', category: 'Sides',
  ...
  {
    id: 'm19', restaurantId: 'r3', category: 'Drinks',
    name: 'Chapman',
  ...
  // ── Naija Delicacy ──────────────────────────────────────────────────
  {
    id: 'm20', restaurantId: 'r4', category: 'Soups',
  ...
  {
    id: 'm21', restaurantId: 'r4', category: 'Soups',
    name: 'Oha Soup',
  ...
  {
    id: 'm22', restaurantId: 'r4', category: 'Soups',
    name: 'Ogbono Soup',
  ...
  {
    id: 'm23', restaurantId: 'r4', category: 'Swallow',
    name: 'Fufu (Cassava)',
  ...
  {
    id: 'm24', restaurantId: 'r4', category: 'Pepper Soup',
  ...
  {
    id: 'm25', restaurantId: 'r4', category: 'Drinks',
    name: 'Palm Wine',
